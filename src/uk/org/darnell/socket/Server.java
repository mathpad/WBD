...
public class Server{
	...
	{	
		try{
			...
			handler.sendMessage(handler.obtainMessage(1,0,0,"Connecting to 192.168.1.18"));
			connection = new Socket(addr, 2004);
			handler.sendMessage(handler.obtainMessage(1,0,0,"Connected"));
